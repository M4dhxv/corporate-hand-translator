    ...
    return (
        <div className="rounded-2xl border border-neutral-200/50 dark:border-neutral-800/50 bg-white dark:bg-neutral-900 p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
                        Train the model to recognize your unique hand gestures
                    </p>
                </div>
                <button
                    onClick={onClose}
            ...
            {hasPersonalized && !isTraining && trainStatus !== 'success' && (
                <div className="mb-4 flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30">
            ...
            {/* Instructions */}
            <div className="mb-6 p-4 rounded-lg bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700">
                    ...
                    return (
                        <div key={label} className="flex items-center gap-3">
                            ...
                            >
                                ...
                                {/* Recording progress */}
                                {isRecording && (
                                    <div className="w-20 h-1.5 bg-neutral-300 dark:bg-neutral-700 rounded-full overflow-hidden">
                                        <div
            ...
            <div className="space-y-3">
                ...
                {/* Success message */}
                {trainStatus === 'success' && (
                    <div className="flex items-center gap-2 px-4 py-3 rounded-lg bg-green-100 dark:bg-green-500/15 border border-green-300 dark:border-green-500/30">
                ...
                {/* Error message */}
                {trainStatus === 'error' && (
                    <div className="flex items-center gap-2 px-4 py-3 rounded-lg bg-red-100 dark:bg-red-500/15 border border-red-300 dark:border-red-500/30">
